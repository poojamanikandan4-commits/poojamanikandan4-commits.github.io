          ...
          {portfolioData.certifications.map((cert, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <div className="flex items-center gap-1 text-xs font-mono text-slate-400 bg-navy-900 px-2.5 py-1 rounded border border-slate-800">
                ...
                {cert.link && (
                  <a
                    ...
                    className="p-2 rounded-lg border border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/10"
